...
// Datos adicionales: publicaciones, seguidores, seguidos


$media_count = !empty($header_data['media_count']) ? $header_data['media_count'] : 0;
$followers_count = "13mil";
$follows_count = "195";
...
?>
<div
	<?php echo $header_classes; ?> <?php echo $header_atts; ?>>
	<style>
		.instagram-column {
			display: flex;
	...
	<a class="sbi_header_link" target="_blank" rel="nofollow noopener" <?php echo $header_link ?><?php echo $header_link_title ?>>
		<div<?php echo $header_text_class; ?>>
			...
			<!-- Columna 2: Número de publicaciones -->
			<div class="instagram-column">
				<div class="instagram-stat">
					<strong><?php echo esc_html($media_count); ?></strong>

				</div>
				<span>Publicaciones</span>
			</div>
			<!-- Columna 3: Número de seguidores -->
			<div class="instagram-column">
				<div class="instagram-stat">
					<strong><?php echo esc_html($followers_count); ?></strong>

				</div>
				<span>Seguidores</span>
			</div>

			<!-- Columna 4: Número de seguidos -->
			<div class="instagram-column">
				<div class="instagram-stat">
					<strong><?php echo esc_html($follows_count); ?></strong>
